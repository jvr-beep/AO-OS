  ...
  return (
    <div className="max-w-3xl">
      ...
      {isOccupied && (
        <div className="grid grid-cols-1 gap-4 mb-4 sm:grid-cols-2">
          <div className="card">
            ...
            <p className="text-xs text-gray-400 mb-2">Atomically releases this locker and assigns the member to the new one.</p>
      ...
      <div className="card mb-4">
        ...
        <p className="text-xs text-gray-400 mb-2">The statuses below are hard-blocked for assignment and access, even under staff override.</p>
      ...
      <div className="card overflow-hidden">
        ...
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y divide-gray-700">
            {events.length === 0 ? (
              <tr><td colSpan={5} className="px-4 py-8 text-center text-sm text-gray-500">No access events.</td></tr>
            ) : events.map((ev) => (
              <tr key={ev.id} className="hover:bg-gray-700/40">
                <td className="px-4 py-2 text-xs text-gray-400">{new Date(ev.occurredAt).toLocaleString()}</td>
                ...
                <td className="px-4 py-2 text-xs text-gray-400 font-mono">{ev.sourceReference ?? '—'}</td>

...
/**
 * Kiosk Welcome — Step 1: Guest identity capture.
 *
 * Every entrant is individually verified — no shared entry.
 * Discreet, minimal, self-guided. No staff interaction required.
 */

...
const STATUS_MAP: Record<string, { color: string; icon: ReactNode; label: string }> = {
  ...
  pending: { color: 'bg-warning text-surface-0', icon: '○', label: 'Awaiting Activation' },
  suspended: { color: 'bg-critical text-surface-0', icon: '●', label: 'Suspended' },
  expired: { color: 'bg-surface-2 text-text-muted', icon: '○', label: 'Expired' },
